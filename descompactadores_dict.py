...
# dicionario que configura o suporta a arquivos compactados relacionando o tipo do arquivo com o
...
descompactadores = carrega_ou_cria_config("descompactadores.json", descompactadores_json_inicial)
